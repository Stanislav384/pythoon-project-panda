...
key_turn_left = 'arrow_left'     # поворот камери праворуч (а світу - ліворуч)
key_turn_right = 'arrow_right'    # поворот камери ліворуч (а світу – праворуч)


key_build = '1'     # побудувати блок перед собою
key_destroy = '2'   # зруйнувати блок перед собою
